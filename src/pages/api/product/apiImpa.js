...
export default async function handler(req, res) {
    ...
    if (action === 'findAll') {
        ...
        try {
            ...
            if (searchTerm.code) {
                filterConditions.code = new RegExp(searchTerm.code.trim(), 'i');
            }
            if (searchTerm.greek) {
                filterConditions.greekDescription = new RegExp(searchTerm.greek.trim(), 'i');
            }
            if (searchTerm.english) {
                filterConditions.englishDescription = new RegExp(searchTerm.english.trim(), 'i');
            }
