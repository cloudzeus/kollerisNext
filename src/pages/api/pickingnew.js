...
export default async function handler(req, res) {
    ...
    if (action === "createPurDoc") {
        ...
        if(!purdoc.success) throw new Error(purdoc.error || "Προέκυψε σφάλμα κατά την δημιουργία του παραστατικού")
        ...
        if(!result.success) throw new Error("Προέκυψε σφάλμα κατά την ανάκτηση των στοιχείων του παραστατικού")
        ...
        return res.status(200).json({ 
            success: true, 
            result: saldocnum,
            message: "Το παραστατικό δημιουργήθηκε με επιτυχία"
         })
    }
