...
import {EditDialog as SubGroupEdit, AddDialog as SubGroupAdd} from '@/GridDialogs/mtrsubgroupDialog';
    ...
    return (
        <AdminLayout>
            ...
            >
                ...
                <Column field="updatedFrom" header="Τροποποιήθηκε Από" body={UpdatedFromTemplate}
                ...
                {user?.role === 'admin' ? (
                    <Column body={actionBodyTemplate} exportable={false} bodyStyle={{textAlign: 'center'}}
...
const RowExpansionGrid = ({id}) => {
    ...
    return (
        <SubGridStyles>
            <span className="subgrid-title">Ομάδα:</span>
            <div className="data-table">
                ...
                >
                    <Column bodyStyle={{textAlign: 'center'}} expander={(data) => SubRowExpansionTemplate(data)}
                            style={{width: '20px'}}/>
                    ...
                    <Column field="groupName" header="'Ονομα Ομάδας"></Column>
                    <Column field="updatedFrom" header="Τροποποιήθηκε Από" tableStyle={{width: '5rem'}}
