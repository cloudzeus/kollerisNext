...
export const ProductCard = () => {
    ...
    const [selectedFilter, setSelectedFilter] = useState(
        { name: 'Προϊόντα στο softOne', filter:  {MTRL: {$exists: true}}, footerText: "Προϊόντα στο softone" },
    );
    ...
    const filters = [
        { name: 'Προϊόντα στο softOne', filter: {MTRL: {$exists: true}}, footerText: "Προϊόντα στο softone" },
        { name: 'Προϊόντα: Δεν υπάρχουν στο softone', filter: {MTRL: {$exists: false}}, footerText: "Not in SoftOne" },
