        ...
        <div>
            ...
            >
                <div className="flex flex-column gap-2">
                    ...
                    <div className='flex'>
                    <InputText className='w-full mr-2' value={state.email} disabled={true}  />
                    <Button icon="pi pi-pencil" severity='secondary' onClick={(e) => setState(prev => ({...prev, email: e.target.value}))}/>
                    </div>
